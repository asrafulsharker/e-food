...
function top() {
    return (
        <div className="" style={{padding:"80px 40px 80px 40px",background:"#fff5ec"}}>
            <div className="row " style={{padding:"20px"}}>
            <div className="col-md-6">
                <p className="top-top-p" style={{fontSize:"35px",fontWeight:"bold",borderLeft:"10px solid red",lineHeight:"40px",padding:"10px"}}>Some top restaurant for dining in or Take away!</p>
            </div>
            <div className="col-md-6">
        ...
        <div className="row" style={{padding:"50px 0px 0px 0px"}}>
            ...
            <div className="m-auto"> <div className="row click-arrow">
